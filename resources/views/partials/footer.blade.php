    ...
    <footer id="footer-part" class="footer-2 footer-3 pt-70">
                        ...
                        <div class="footer-address">
                            <ul>
                                <li>
                                    ...
                                    <div class="address">
                                        <h5>Channels Gas Plant</h5>
                                        <p>1 Limpson Road by River <br/>Valley Estate Ojodu Berger <br>Lagos Nigeria.</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon">
        ...
        <div class="copyright pt-15 pb-15 text-center">
           <p>&copy; All Rights Reserved Channels Gas Plant Ltd {{Date('Y')}}.</p>
        </div>
    ...
    <a href="#" class="back-to-top">
        <img src="{{asset('/chnlsgasplant/images/back-to-top.png')}}" alt="Icon">
    </a>
