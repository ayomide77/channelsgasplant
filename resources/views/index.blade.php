        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title text-center">
                    ...
                    <p>Channels Gas Plant is your go to gas plant delivery services. We specializes in home delivery and services of all kinds of LPG.  We are fast, efficient and reliable.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title text-center">
                    ...
                    <p>Nunc molestie mi nunc, nec accumsan libero dignissim sit amet. Fusce sit amet tincidunt metus.
                        Nunc eu risus suscipit massa dapibus blandit. Vivamus ac commodo eros.</p>
                </div>
            </div>
        </div>
              <div class="row">
